...
public final class EmployeeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.techgeeknext.employee.EmployeeRequest,
      com.techgeeknext.employee.EmployeeResponse> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = com.techgeeknext.employee.EmployeeRequest.class,
      responseType = com.techgeeknext.employee.EmployeeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.techgeeknext.employee.EmployeeRequest,
      com.techgeeknext.employee.EmployeeResponse> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<com.techgeeknext.employee.EmployeeRequest, com.techgeeknext.employee.EmployeeResponse> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod = 
              io.grpc.MethodDescriptor.<com.techgeeknext.employee.EmployeeRequest, com.techgeeknext.employee.EmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "EmployeeService", "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.techgeeknext.employee.EmployeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.techgeeknext.employee.EmployeeResponse.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(com.techgeeknext.employee.EmployeeRequest request,
        io.grpc.stub.StreamObserver<com.techgeeknext.employee.EmployeeResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.techgeeknext.employee.EmployeeResponse>(
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public com.techgeeknext.employee.EmployeeResponse getEmployee(com.techgeeknext.employee.EmployeeRequest request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.techgeeknext.employee.EmployeeResponse> getEmployee(
        com.techgeeknext.employee.EmployeeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((com.techgeeknext.employee.EmployeeRequest) request,
              (io.grpc.stub.StreamObserver<com.techgeeknext.employee.EmployeeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.techgeeknext.employee.EmployeeServiceOuterClass.getDescriptor();
    }
